<pre><?php 
/*
 * 直接运行该文件，当前目录中所有中文文件名将被转换成拼音文件名
 * 并不保证所有中文都可以正确转换。该页会打印出所有文件原来的中文名作为对比
 */
/*
 * TODO  某些汉字不能成功转换，例如“怡”
 */
...
foreach($aAllInThisDir as $value) 
{
   ...
   {  
      ...
      $pinyin = $Pinyin->get_pinyin($value);
      rename(iconv('utf-8', 'gb2312', $value), $pinyin);
   }
}
print_r( $aAllFilesToBeRename ); // 作为检查和对照，打印原来的中文名
